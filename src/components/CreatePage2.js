        ...
        <div className="col-xs-12 container"> 
          ...
          <div className="createInputBox col-xs-12 container">
            <div className="createContinue text-center col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4"> 
              ...
              <h1 className="createInputTitle col-xs-12 noPadd"> YOUR TOKEN CREATION IS COMPLETE </h1> 
              
              <h1 className="createInputSubtitle col-xs-12 faded noPadd"> {this.state.githubInfo.repoName} </h1> 
            
              <h1 className="createInputSubtitle col-xs-12 noPadd"> Your Current Etherium Address </h1> 
                <div className="ethAddressBox col-xs-12"> <p className="ethAddressText"> {this.state.projEthAddress} </p> </div>  

              <h1 className="createInputSubtitle col-xs-12 noPadd"> Balance </h1>
              ...
              <div className="btnGoldExp createContinueBtn col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4" onClick={()=>{this.props.pageChange('MANAGE');}} >
                <h5> CONTINUE </h5>
              </div>
