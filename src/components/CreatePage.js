...
class CreatePage extends Component {
  ...
  checkContent(){
    ...
    // Not sure what kind of checks you want to do here, so basic 'not empty' stuff here for now.
      if ((document.getElementById("tokenName").value === "") || (document.getElementById("ethAmount").value === "") || (document.getElementById("totalSupply").value === ""))
    {
        // Missing data 
    ...
    else this.props.pageChange('CREATE_2'); 
  }
          ...
          <div className="createInputBox col-xs-12 container">
            <div className="createInputForm col-xs-12 col-sm-6 col-md-4 col-sm-offset-1"> 
              ...
              <h1 className="createInputTitle col-xs-12 noPadd"> TOKEN NAME </h1> 
                <input required type="text" maxLength="3" id="tokenName" className="form-control formEdit" name="tokenName" placeholder="A three-letter token ticker" value={this.state.tokenName} onChange={this.handleInputChange} />

              <h1 className="createInputTitle col-xs-12 noPadd"> ETHER AMOUNT </h1> 
                <input required type="text" maxLength="5" id="ethAmount" className="form-control formEdit" name="ethAmount" placeholder="Value will be divided among tokens" value={this.state.ethAmount} onChange={this.handleInputChange} />
