    ...
    return (
      <div className='homePageContainer container'> 
        ...
        <div className="tabContainer row col-xs-12">
          ...
          <h4 className="faded tabClaimBounties col-xs-6 col-sm-4 col-md-2 noPadd"  onClick={()=> this.props.pageChange('CLAIM')}> 
            CLAIM BOUNTIES
          </h4> 
        </div>       
        ...
        <div className="dashboardContainer row col-xs-12"> 
          ...
          <div className="cardListContainer col-xs-12 col-md-8">
            {this.props.githubInfo.map((Element,i) => <IssueCard key={i} pageChange={(x)=> this.props.pageChange(x)} githubInfo1={Element}/>)}
          </div> 
