          ...
          <div className="manageProjectContainer col-xs-12 col-md-6"> 
            <div className="manageProjectMain col-xs-12"> 
              <div className="manageProjectMainContents col-xs-12 noPadd" > 
                ...
                <div className="unlockBtnHolder col-xs-12 noPadd"> 
                  <div className="btnGoldExp createContinueBtn col-xs-10 col-sm-8 col-md-5" onClick={()=>{alert('Redemptions Unlocked. Placeholder')}} >
                    <h5> Unlock Redemption </h5>
                  </div>
                </div> 
